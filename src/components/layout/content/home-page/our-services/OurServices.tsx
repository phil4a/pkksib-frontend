	...
	return (
		<section>
			<div className='layout-container py-16 lg:py-25'>
				...
				<div className='grid gap-4 md:gap-5 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-8'>
					{isLoading ? (
						<SkeletonLoader
							count={4}
	...
	return (
		<div className=''>
			<div className='bg-light-gray rounded-xl relative overflow-hidden group aspect-square w-full h-auto md:h-[320px] md:h-[480px] '>
				...
				<div className='absolute bottom-0 left-0 right-0 w-full aspect-square'>
					<Image
						src={image.url}
						alt={title}
						fill
			...
			<p className='block md:hidden text-lg font-semibold pt-3'>{title}</p>
		</div>
	);
}
